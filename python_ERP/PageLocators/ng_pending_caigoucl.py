...
class NgPending:
    ...
    #~~~~~~~~~~~~~~~~采购入库待处理
    ng_rku_pending = (By.XPATH,'//*[@id="menu_13121700"]')
    #废弃
    abandon_yq = (By.XPATH,'//select[@class="form-control input-medium input-inline  order-do"]//option[text()="废弃"]')
    #pass给QC
    pass_qc = (By.XPATH,'//select[@class="form-control input-medium input-inline  order-do"]//option[2]')
    #NG待采购处理
    rku_ng = (By.XPATH,'//select[@class="form-control input-medium input-inline  order-do"]//option[3]')